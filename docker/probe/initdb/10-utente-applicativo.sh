#!/bin/sh
# -----------------------------------------------------------------
# 10-utente-applicativo.sh — utente applicativo della base dati della SONDA
...
#
# Vale per la base dati della SONDA, che oggi e' PREDISPOSTA e non ancora usata dal
# codice (la sonda scrive su SQLite): i privilegi si preparano adesso perche' il
# porting non debba anche inventarsi il modello di accesso, e perche' un'installazione
# non resti con il proprietario come unico utente -- e' cosi' che si finisce per
# collegare l'applicazione da superuser "provvisoriamente".
#
